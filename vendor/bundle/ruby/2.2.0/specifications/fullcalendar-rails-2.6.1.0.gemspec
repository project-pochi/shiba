# -*- encoding: utf-8 -*-
# stub: fullcalendar-rails 2.6.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<jquery-rails>, ["< 5.0.0", ">= 4.0.5"])
      s.add_runtime_dependency(%q<jquery-ui-rails>, [">= 5.0.2"])
      s.add_runtime_dependency(%q<momentjs-rails>, [">= 2.9.0"])
      s.add_development_dependency(%q<rake>, ["~> 0"])
    else
      s.add_dependency(%q<jquery-rails>, ["< 5.0.0", ">= 4.0.5"])
      s.add_dependency(%q<jquery-ui-rails>, [">= 5.0.2"])
